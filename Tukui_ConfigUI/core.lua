...
local function Local(o)
	...
	if o == "TukuiConfigUIskinkle" then o = TukuiL.option_skin_kle end
	if o == "TukuiConfigUIskinhookkleright" then o = TukuiL.option_skin_hookkleright end
	if o == "TukuiConfigUIskinembedright" then o = TukuiL.option_skin_embedright end
