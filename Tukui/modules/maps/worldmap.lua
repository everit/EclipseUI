...
local SmallerMapSkin = function()
	...
	WorldMapFrameTitle:SetFont(unpack(T.Fonts.mTitle.setfont))
	...
	WorldMapQuestShowObjectivesText:SetFont(unpack(T.Fonts.mGeneral.setfont))
	...
	WorldMapShowDigSitesText:SetFont(unpack(T.Fonts.mGeneral.setfont))
	...
	WorldMapFrameAreaLabel:SetFont(unpack(T.Fonts.mArea.setfont))
