...
function EmbedSkada()
	if #windows == 1 then
		...
		windows[1].bargroup:SetPoint("TOPRIGHT", TukuiTabsRight, "TOPRIGHT", -2, -2)
		
		barmod.ApplySettings(barmod, windows[1])
	elseif #windows == 2 then
		windows[1].db.barwidth = ((C["chat"].chatwidth - 4) / 2) - (borderWidth + T.mult)
		windows[1].db.barheight = (C["chat"].chatheight - (barSpacing * 5)) / 8
		windows[1].db.barmax = (math.floor(C["chat"].chatheight / windows[1].db.barheight) - 1)
		windows[1].db.background.height = 1
		windows[1].db.spark = false
		...
		windows[2].db.barwidth = ((C["chat"].chatwidth - 4) / 2) - (borderWidth + T.mult)
		...
		windows[2].bargroup:SetPoint("TOPLEFT", TukuiTabsRight, "TOPLEFT", 2, -2)		
	...
	elseif #windows > 2 then
		...
		windows[3].db.barwidth = ((C["chat"].chatwidth - 4) / 2) - (borderWidth + T.mult)
