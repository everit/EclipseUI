...
Mod_AddonSkins:RegisterSkin("Recount",function(Skin, skin, Layout, layout, config)
	...
	local function SkinFrame(frame)
	    ...
	    frame.bgMain:SetPoint("BOTTOMLEFT",frame,"BOTTOMLEFT", 0, 30)
	    frame.bgMain:SetPoint("BOTTOMRIGHT",frame,"BOTTOMRIGHT", 0, 30)
	    frame.bgMain:SetPoint("TOP",frame,"TOP",0,-25)
	    ...
	    frame.CloseButton:SetPoint("TOPRIGHT",frame,"TOPRIGHT",-5, -12)
		frame.Title:SetPoint("TOPRIGHT",frame,"TOPRIGHT",-5, -12)
	...
	Recount.UpdateBarTextures = function(self)
		...
		Recount:SetFont("Eclipse UFFont")
	end
