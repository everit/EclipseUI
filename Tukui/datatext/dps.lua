if TukuiCF["datatext"].dps_text and TukuiCF["datatext"].dps_text > 0 then
	...
	dText:SetFont(font, font_size, font_style)
	dText:SetShadowOffset(font_shadow and 1 or 0, font_shadow and -1 or 0)
	...
	function getDPS()
		if (dmg_total == 0) then
			return ("0 " .. cStart .. tukuilocal.datatext_dps)
		else
			return string.format("%.1f " .. cStart .. tukuilocal.datatext_dps, (dmg_total or 0) / (cmbt_time or 1))
		end
	end
