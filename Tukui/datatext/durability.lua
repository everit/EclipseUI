if TukuiCF["datatext"].dur and TukuiCF["datatext"].dur > 0 then
	...
	Text:SetFont(TukuiCF["fonts"].datatext_font, TukuiCF["fonts"].datatext_font_size, TukuiCF["fonts"].datatext_font_style)
	Text:SetShadowOffset(TukuiCF["fonts"].datatext_font_shadow and 1 or 0, TukuiCF["fonts"].datatext_font_shadow and -1 or 0)
