-- if TukuiCF["datatext"].stat_block then
	...
	TukuiDB.CreatePanel(memorystat, 70, TukuiDB.infoheight, "TOPLEFT", UIParent, "TOPLEFT", TukuiDB.Scale(8), TukuiDB.Scale(-8))
	...
	TukuiDB.CreatePanel(fpsstat, 70, TukuiDB.infoheight, "TOPLEFT", memorystat, "TOPLEFT", memorystat:GetWidth() + 3, 0)
	...
	TukuiDB.CreatePanel(latencystat, 70, TukuiDB.infoheight, "TOPLEFT", fpsstat, "TOPLEFT", fpsstat:GetWidth() + 3, 0)
	...
	TukuiDB.CreatePanel(timestat, 70, TukuiDB.infoheight, "TOPLEFT", latencystat, "TOPLEFT", latencystat:GetWidth() + 3, 0)
