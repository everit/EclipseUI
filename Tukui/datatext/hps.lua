...
if TukuiCF["datatext"].hps_text and TukuiCF["datatext"].hps_text > 0 then
	...
	hText:SetFont(font, font_size, font_style)
	hText:SetShadowOffset(font_shadow and 1 or 0, font_shadow and -1 or 0)
	...
	function get_hps()
		if (actual_heals_total == 0) then
			return ("0 " .. cStart .. tukuilocal.datatext_hps)
		else
			return string.format("%.1f " .. cStart .. tukuilocal.datatext_hps, (actual_heals_total or 0) / (cmbt_time or 1))
		end
	end
